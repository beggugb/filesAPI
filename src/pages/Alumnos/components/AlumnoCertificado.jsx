...
const AlumnoCertificado = () =>{
    const dispatch = useDispatch()
    const { item } = useSelector(state => state.certificados) 
  ...
  <>      
      ...
      <Row className="perfilPreviewx">
        ...
        <img          
          ...
          src={api + "/static/images/certificados/md/" + item.filename}
        />}
        </Col>
      </Row>
      { item.id ?
...
export default AlumnoCertificado;
